namespace OneMarkDotNet
{
    ...
    public class OneNoteToMarkdownConverter
    {
        ...
        public string Convert(string oneNoteXml)
        {
            ...
            {
                var titleText = ExtractTextFromOE(titleElement.Element(Ns + "OE"));
            ...
            foreach (var outline in outlines)
            {
                ...
                if (oeChildren != null)
                {
                    ProcessOEChildren(oeChildren, sb, 0);
                }
            }
        ...
        private void ProcessOEChildren(XElement oeChildren, StringBuilder sb, int indentLevel)
        {
            var oeElements = oeChildren.Elements(Ns + "OE");
            foreach (var oe in oeElements)
            {
                ProcessOE(oe, sb, indentLevel);
            }
        }
        ...
        private void ProcessOE(XElement oe, StringBuilder sb, int indentLevel)
        {
            ...
            if (tElements.Count > 0)
            {
                ...
                {
                    var headingLevel = DetectHeadingLevel(oe);
            ...
            {
                ProcessOEChildren(childOeChildren, sb, indentLevel + 1);
            }
        }
        ...
        private void ProcessImage(XElement imageElement, StringBuilder sb)
        {
        ...
        private int DetectHeadingLevel(XElement oe)
        {
