namespace OneMarkDotNet
{
    ...
    {
        private const string RibbonXmlResourceName = "OneMarkDotNet.Ribbon.xml";
        ...
        public static string GetThemeMenuXml(List<Theme> themes)
        {
            ...
            sb.AppendFormat(
                "<button id=\"OpenThemeDirButton\" label=\"Open Theme Directory\" onAction=\"OnOpenThemeDirClick\" />");
            sb.AppendFormat(
                "<button id=\"ReloadThemesButton\" label=\"Reload Themes\" onAction=\"OnReloadThemesClick\" />");
            sb.Append("</menu>");
